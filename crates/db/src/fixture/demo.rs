...
fn seed_demo_inner(conn: &mut SqliteConnection) -> Result<DemoSeed, diesel::result::Error> {
    ...
    let athena_seats: Vec<CommitSeat> = vec![
        CommitSeat { seat_position: 0, rower_id: rower_ids[17], is_cox: true },
        CommitSeat { seat_position: 1, rower_id: rower_ids[6],  is_cox: false },
        CommitSeat { seat_position: 2, rower_id: rower_ids[2],  is_cox: false },
        CommitSeat { seat_position: 3, rower_id: rower_ids[3],  is_cox: false },
        CommitSeat { seat_position: 4, rower_id: rower_ids[8],  is_cox: false },
        CommitSeat { seat_position: 5, rower_id: rower_ids[1],  is_cox: false },
        CommitSeat { seat_position: 6, rower_id: rower_ids[7],  is_cox: false },
        CommitSeat { seat_position: 7, rower_id: rower_ids[4],  is_cox: false },
        CommitSeat { seat_position: 8, rower_id: rower_ids[0],  is_cox: false },
    ];
    Lineup::commit_for_boat(conn, p_mon.id, athena_id, &athena_seats)?;

    let artemis_id = boat_ids[3];
    let artemis_seats: Vec<CommitSeat> = vec![
        CommitSeat { seat_position: 0, rower_id: rower_ids[25], is_cox: true },
        CommitSeat { seat_position: 1, rower_id: rower_ids[14], is_cox: false },
        CommitSeat { seat_position: 2, rower_id: rower_ids[20], is_cox: false },
        CommitSeat { seat_position: 3, rower_id: rower_ids[22], is_cox: false },
        CommitSeat { seat_position: 4, rower_id: rower_ids[13], is_cox: false },
    ];
...
fn demo_boats() -> Vec<NewBoat> {
    vec![
        NewBoat { name: "Titan".into(), weight_class: BoatWeightClass::Heavy, seat_count: 8, has_cox: IntBool::TRUE, oars_per_seat: 1, acquired_at: None, manufactured_at: None, stroke_side: Side::Starboard, cox_position: CoxPosition::Stern },
        NewBoat { name: "Athena".into(), weight_class: BoatWeightClass::Medium, seat_count: 8, has_cox: IntBool::TRUE, oars_per_seat: 1, acquired_at: None, manufactured_at: None, stroke_side: Side::Starboard, cox_position: CoxPosition::Stern },
        NewBoat { name: "Demeter".into(), weight_class: BoatWeightClass::Medium, seat_count: 8, has_cox: IntBool::TRUE, oars_per_seat: 1, acquired_at: None, manufactured_at: None, stroke_side: Side::Port, cox_position: CoxPosition::Stern },
        NewBoat { name: "Artemis".into(), weight_class: BoatWeightClass::Medium, seat_count: 4, has_cox: IntBool::TRUE, oars_per_seat: 1, acquired_at: None, manufactured_at: None, stroke_side: Side::Starboard, cox_position: CoxPosition::Bow },
        NewBoat { name: "Hestia".into(), weight_class: BoatWeightClass::Medium, seat_count: 4, has_cox: IntBool::TRUE, oars_per_seat: 1, acquired_at: None, manufactured_at: None, stroke_side: Side::Port, cox_position: CoxPosition::Bow },
        NewBoat { name: "Zephyr".into(), weight_class: BoatWeightClass::Medium, seat_count: 2, has_cox: IntBool::FALSE, oars_per_seat: 1, acquired_at: None, manufactured_at: None, stroke_side: Side::Port, cox_position: CoxPosition::Stern },
    ]
}
...
fn demo_rowers() -> Vec<NewRower> {
    ...
    vec![
        ...
        { let mut r = NewRower::sweep("Nico", Medium, Sk::Intermediate, St::Strong, H::Tall, Either); r.sweep_bias = SweepBias::new(0); r },
        NewRower::sweep("Oscar",  Heavy,  Sk::Expert,        St::VeryStrong,   H::Tall,     Port),
        NewRower::sweep("Priya",  Medium, Sk::Master,        St::Strong,       H::Medium,   Starboard),
        NewRower::sweep("Quinn",  Light,  Sk::Intermediate,  St::Strong,       H::Medium,   Port),
        NewRower::sweep("Rosa",   Medium, Sk::Expert,        St::Intermediate, H::Medium,   Starboard),
        NewRower::sweep("Sam",    Heavy,  Sk::Expert,        St::Strong,       H::Tall,     Either),
        { let mut r = NewRower::sweep("Lena", Light, Sk::Expert, St::Weak, H::Short, Either); r.is_designated_cox = IntBool::TRUE; r },
        { let mut r = NewRower::sweep("Yuki", Light, Sk::Master, St::Weak, H::Short, Either); r.is_designated_cox = IntBool::TRUE; r },
        { let mut r = NewRower::sweep("Ravi", Heavy, Sk::Novice, St::Weak, H::Tall, Starboard); r.can_cox = IntBool::FALSE; r },
        NewRower::sweep("Sara",   Medium, Sk::Novice,        St::Intermediate, H::Medium,   Port),
        NewRower::sweep("Theo",   Light,  Sk::Novice,        St::Weak,         H::Short,    Either),
        NewRower::sweep("Uma",    Medium, Sk::Novice,        St::Intermediate, H::Medium,   Starboard),
        NewRower::sweep("Vera",   Light,  Sk::Novice,        St::Weak,         H::Short,    Port),
        { let mut r = NewRower::sweep("Will", Heavy, Sk::Novice, St::Intermediate, H::Tall, Starboard); r.can_cox = IntBool::FALSE; r },
        { let mut r = NewRower::sweep("Xena", Medium, Sk::Novice, St::Intermediate, H::Medium, Either); r.can_cox = IntBool::TRUE; r },
    ]
}
